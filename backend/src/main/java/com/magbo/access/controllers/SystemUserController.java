    ...
    private void validatePermissoes(String permissoes) {
        ...
        for (String p : parts) {
            ...
            if (!val.equals("*") &&
                ...
                !val.equals(com.magbo.access.security.Permissions.PPMS_READ)) {
                throw new IllegalArgumentException("Permissão inválida: " + val + ". Valores válidos: *, MEAL_ENTITLEMENT_WRITE, EXIT_PERMISSION_WRITE, ATTEMPTS_READ, PPMS_READ");
            }
        }
    }
