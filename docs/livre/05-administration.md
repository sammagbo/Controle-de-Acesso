...
`[CAPTURE : le formulaire d'un opérateur — le rôle, les cases de secteurs, et la grille des
permissions particulières juste en dessous]`
...
`[CAPTURE : la carte d'un créneau, avec le champ rotulo, les deux tolérances et les pastilles de
classes]`
`[CAPTURE : l'aperçu d'impression de l'affiche — bandeau bleu foncé, pastilles en couleur, une
page par passage]`
...
`[CAPTURE : l'écran Configuration du système — une ligne avec sa valeur, son défaut écrit à côté,
